    ...
    <div className="relative shrink-0" ref={boxRef}>
      <button
        className={`hover:bg-hover hover:text-content rounded px-1 leading-none ${
          ...
          open ? 'text-content' : 'text-subtle opacity-0 group-hover/header:opacity-100'
        }`}
      ...
      {open && (
        ...
        <div className="border-edge-strong bg-elevated absolute top-full right-0 z-50 mt-0.5 max-w-52 min-w-36 rounded-md border py-1 shadow-xl">
          {onOpenAll && (
            <GroupMenuItem
              icon={<GridIcon />}
