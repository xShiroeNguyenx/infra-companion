...
export function AiExplainPanel() {
  ...
  return (
    <div
      className={`bg-elevated/95 border-edge-strong absolute ${top} right-3 z-40 flex max-h-[calc(100%-8.5rem)] w-[460px] max-w-[85vw] flex-col overflow-hidden rounded-lg border opacity-75 shadow-2xl transition-opacity duration-150 hover:opacity-100`}
    >
