...
**Current release: v0.2.6 (Phase 0–6)**  &nbsp;|&nbsp; Windows · macOS · Linux  &nbsp;|&nbsp; Electron 42 · React 19 · TypeScript
...
```bash
pnpm test
# 1099 tests; on Node 20 the node:sqlite suites (vault-merge, replication clusters, local-dev
